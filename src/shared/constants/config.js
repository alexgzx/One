...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/decolua/One/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://one.com/api/donate",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "One",
  installCmd: "npm i -g One",
  installCmdLatest: "npm i -g One@latest --prefer-online",
