  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-bg relative">
      ...
      <div className="pointer-events-none fixed inset-0 -z-0">
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-primary/[0.04] dark:bg-primary/[0.08] rounded-full blur-[120px]" />
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-brand-400/[0.03] dark:bg-brand-400/[0.06] rounded-full blur-[100px]" />
      </div>
      ...
      {/* Sidebar - Desktop */}
      <div className="hidden lg:flex group/sidebar">
